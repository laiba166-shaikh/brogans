  ...
  return (
    <Fragment>
      ...
      >
        ...
        {/* feature icon */}
        <FeatureIconFour sapceTopClass="pt-10" spaceBottomClass="pb-90" />
        {/* tab product */}
        <TabProductFour spaceBottomClass="pb-100" category="organic food" />
        {/* banner */}
        <BannerFive />
        {/* countdown */}
        <CountDownTwo
        ...
        />
        {/* newsletter */}
        <NewsletterTwo spaceTopClass="pt-100" spaceBottomClass="pb-100" />
      </LayoutThree>
    </Fragment>
  );
};
